...
export declare const makeRabbitDecorator: <T extends Partial<RabbitHandlerConfig>>(input: T) => (config: Pick<RabbitHandlerConfig, Exclude<"queue", keyof T> | Exclude<"type", keyof T> | Exclude<"name", keyof T> | Exclude<"deserializer", keyof T> | Exclude<"connection", keyof T> | Exclude<"exchange", keyof T> | Exclude<"routingKey", keyof T> | Exclude<"queueOptions", keyof T> | Exclude<"errorBehavior", keyof T> | Exclude<"errorHandler", keyof T> | Exclude<"assertQueueErrorHandler", keyof T> | Exclude<"createQueueIfNotExists", keyof T> | Exclude<"allowNonJsonMessages", keyof T> | Exclude<"usePersistentReplyTo", keyof T> | Exclude<"batchOptions", keyof T>>) => <TFunction extends Function, Y>(target: object | TFunction, propertyKey?: string | symbol | undefined, descriptor?: TypedPropertyDescriptor<Y> | undefined) => void;
